...
export default function Home() {
  ...
  const newArrivals = products.slice(0, 3) // Get first 3 products
      ...
      <section className="relative h-[80vh] bg-black text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl">
            <h1
              className={`text-5xl md:text-7xl font-bold mb-6 transition-all duration-500 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
            >
              WEAR ART.
              <br />
              OUR ART.
            ...
            <p
              className={`text-xl mb-8 text-gray-200 transition-all duration-500 delay-200 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
            >
            ...
            <div
              className={`transition-all duration-500 delay-300 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
            >
              <Link
                href="/products"
